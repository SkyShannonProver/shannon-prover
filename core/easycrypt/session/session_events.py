...
JSONL events so workflow tree/eval code can consume stable facts
...
EVENT_PAYLOAD_SCHEMAS: dict[str, dict[str, dict[str, _FIELD_TYPE]]] = {
    ...
    "ec.routing": {
        ...
        # The underlying exception behind a fallback reason (e.g. which
        # OSError made the daemon path bail) — reasons alone were unqueryable.
        "optional": {"detail": str},
    },
