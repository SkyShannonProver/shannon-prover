...
from core.easycrypt.session.session_commit_response import (
...
def observe_session(
    ...
    *,
    ...
    if projection is not None:
        ...
        session_completion_candidate = projection.session_completion_candidate
        ...
        qed_committed = False
        session_completion_candidate = False
